			...
			setTimeout(
				function() {
					...
					if (settings.forceIE11Workaround) ie11workaround = true;
						...
						try { xhr[i].upload.onprogress; ie11workaround = false; }
						catch (e) { ie11workaround = true; }
					}
					if (ie11workaround) {
						...
						xhr[i].upload.onload = function() {}.bind(this);
