/*
	...
	GNU LGPLv3 License
	Modified: added _workerPath support for custom worker location
*/
...
Speedtest.prototype = {
  ...
  start: function() {
    ...
    var workerUrl = this._workerPath || "speedtest_worker.js";
    this.worker = new Worker(workerUrl + "?r=" + Math.random());
