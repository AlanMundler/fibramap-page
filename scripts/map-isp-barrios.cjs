...
const KNOWN_BARRIOS = {
  ...
  'Internet Córdoba': [
    // Official list from internetcordoba.com.ar (73 barrios)
    ...
    'AMPLIACION RENACIMIENTO', 'AMPLIACION YAPEYU',
    'BAJO GENERAL PAZ', 'BAJO YAPEYU',
    'CIUDAD EVITA', 'COLON', 'COLONIA LOLA',
    'COOP. 16 DE ABRIL', 'COOP. EL PROGRESO',
    'COOP. EL RENUEVO', 'COOP. FUTURA',
    'COOP. GUAYACAN', 'COOP. LOS ANDES',
    'COOP. SOL NACIENTE', 'COOP. LA UNIDAD',
    'CORRAL DE PALOS', 'CRISOL NORTE', 'CRISOL SUD',
    'DEAN FUNES', 'DEAN FUNES DE HORIZONTE',
    'EMAUS', 'EMPALME',
    'EMPALME CASAS DE OBREROS Y EMPLEADOS',
    'FERROVIARIO MITRE', 'GENERAL PAZ',
    'GENERAL PUEYREDON', 'HORIZONTE DE SAN JAVIER',
    'IPV CAMINO VILLA POSSE',
    'JOSE IGNACIO DIAZ 1A SECCION',
    'JOSE IGNACIO DIAZ 2A SECCION',
    'LA TABLITA', 'LAS LILAS',
    'LILAS DE HORIZONTE', 'LOS ARTESANOS',
    'LOS CEIBOS', 'LOS JOSEFINOS', 'LOS PARAISOS',
    'MAIPU 1A SECCION', 'MAIPU 2A SECCION',
    'MALDONADO', 'MAULLER', 'MIRADOR', 'MIRALTA',
    'NICOLAS AVELLANEDA', 'PARQUE SAN VICENTE',
    'PORTAL DE CORDOBA', 'RENACIMIENTO',
    'RIVADAVIA', 'SAN CAYETANO', 'SAN JAVIER',
    'SAN JAVIER ANEXO', 'SANTA BARBARA',
    'SARMIENTO', 'TALLERES SUD', 'URQUIZA',
    'VILLA ARGENTINA', 'VILLA BOEDO',
    'VILLA BOEDO ANEXO', 'VILLA BUSTOS',
    'YAPEYU', 'ZEPA', 'ZEPA A', 'ZEPA B', 'ZEPA C',
  ],
  'Batcom': [
